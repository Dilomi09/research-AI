...
export async function synthesizeWithOpenRouter(
  ...
  const res = await fetch('https://openrouter.ai/api/v1/chat/completions', {
    ...
    body: JSON.stringify({
      model: model,
      messages: [
        { role: 'system', content: finalSystemPrompt + (searchDomain ? `\n\nIMPORTANT: The user has restricted their search focus to: ${searchDomain}. Prioritize information from this domain.` : '') },
        ...formattedMessages
      ],
      stream: true
    }),
