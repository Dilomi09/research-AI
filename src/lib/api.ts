...
export async function synthesizeWithOpenRouter(
  ...
  const res = await fetch('https://openrouter.ai/api/v1/chat/completions', {
    ...
    body: JSON.stringify({
      model: model,
      messages: [
        { role: 'system', content: "You are an independent, helpful expert assistant. Answer the user's query using the provided search results. The search results contain citation numbers like [1], [2]. You MUST include these citations in your response to indicate where the information came from. IMPORTANT: The search results were generated by another AI (Perplexity). Do NOT adopt its persona. Do NOT say you are developed by Perplexity. Answer in your own voice. Be comprehensive, clear, and format your response in Markdown." },
